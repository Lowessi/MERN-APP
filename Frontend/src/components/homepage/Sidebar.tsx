...
const Sidebar = () => {
  return (
    <div className="px-5 py-5 sticky top-0 ">
      <aside className="w-70 h-100 p-4 bg-white shadow-sm border border-gray-300 rounded-[15px]">
        <div className="bg-green-100 rounded-lg p-4 mb-4 text-center">
          <div className="text-4xl font-bold text-green-600">W</div>
          <p className="mt-2 font-semibold">Wis Wit</p>
        ...
        <button className="mt-6 text-green-700 hover:underline text-sm">
          + Post a free job
        </button>
      </aside>
    </div>
